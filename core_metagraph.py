...
class CoreMetagraph:
    ...
    def __init__(self):
        # Core configuration
        self.contract_address = "0x3dACb0Ac7A913Fa94f383f7d6CF0a7BC2b5498DD"
    ...
    async def get_network_stats(self):
        ...
        try:
            total_miners, total_validators, total_stake, total_subnets = self.contract.functions.getNetworkStats().call()
            return {
    ...
    async def get_miner_info(self, address: str):
        ...
        try:
            is_active, core_stake, btc_stake, subnet_id = self.contract.functions.getMinerInfo(address).call()
            return {
                "is_active": is_active,
    ...
    async def get_validator_info(self, address: str):
        ...
        try:
            is_active, core_stake, btc_stake, subnet_id = self.contract.functions.getValidatorInfo(address).call()
            return {
                "is_active": is_active,
                "core_stake": Web3.from_wei(core_stake, 'ether'),
                "btc_stake": Web3.from_wei(btc_stake, 'ether'),
