...
def register_v2_entities():
    ...
    deployer_private_key = (
        "0xa07b6e0db803f9a21ffd1001c76b0aa0b313aaba8faab8c771af47301c4452b4"
    )
    ...
    for name, address, private_key, entity_type, stake_amount in entities:
        ...
        try:
            ...
            signed_txn = w3.eth.account.sign_transaction(
                transfer_txn, deployer_private_key
            )
        ...
        try:
            ...
            if entity_type == "miner":
                register_function = main_contract.functions.registerMiner(
                    0, stake_wei, 0, api_endpoint  # subnetId  # coreStake  # btcStake
                )
            else:
    ...
    print(
        f"🔍 Check contract: https://scan.test.btcs.network/address/{contract_address}"
    )
