...
def main():
    ...
    # Load contract ABIs
    try:
        contract_abi_path = "../moderntensor_aptos/mt_core/smartcontract/artifacts/contracts/ModernTensorAI_v2_Bittensor.sol/ModernTensorAI_v2_Bittensor.json"
    ...
    print(f"💰 Main account balance: {web3.from_wei(web3.eth.get_balance(main_account.address), 'ether')} CORE")
    ...
    for entity in entities:
        try:
            ...
            raw_gas_tx = getattr(signed_gas_tx, 'rawTransaction', getattr(signed_gas_tx, 'raw_transaction', None))
            ...
            raw_approve_tx = getattr(signed_approve_tx, 'rawTransaction', getattr(signed_approve_tx, 'raw_transaction', None))
            ...
            raw_register_tx = getattr(signed_register_tx, 'rawTransaction', getattr(signed_register_tx, 'raw_transaction', None))
