...
class CardanoFullRunner:
        ...
        try:
            with open(log_file_path, 'r') as f:
                ...
                while self.running:
                    ...
                    elif any(keyword in line.lower() for keyword in ['score', 'mining', 'generated']):
                    ...
                    elif any(keyword in line.lower() for keyword in ['task', 'assignment', 'received']):
    ...
    def run_full_test(self, duration=600):
        ...
        try:
            ...
            # Start Miner (if script exists)
            miner_script = "test_cardano_miner.py"
            if Path(miner_script).exists():
                self.start_process(
                    miner_script,
                ...
                logger.info("⚠️  Miner script not found, running validators only")
