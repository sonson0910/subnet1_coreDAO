...
def run_miner_instance():
    ...
    validator_url = os.getenv("SUBNET1_VALIDATOR_URL2")
    ...
    miner_port = int(os.getenv("SUBNET1_MINER_PORT2", 9002)) # Chọn cổng cho miner subnet 1
    miner_id = os.getenv("SUBNET1_MINER_ID2", f"subnet1_miner_{miner_port}") # Tạo ID mặc định
