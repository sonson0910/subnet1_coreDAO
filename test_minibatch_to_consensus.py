...
def test_minibatch_score_storage():
    ...
    clip_scores = [
        ValidatorScore(
            task_id="slot_841677_batch_1_task_001",
            miner_uid="7375626e6574315f6d696e65725f31",  # miner_1 hex
            validator_uid="7375626e6574315f76616c696461746f725f303031",  # validator_001 hex
            score=0.6268,  # From logs
            timestamp=time.time(),
            cycle=slot,
        ),
        ValidatorScore(
            task_id="slot_841677_batch_1_task_002",
            miner_uid="7375626e6574315f6d696e65725f32",  # miner_2 hex
            validator_uid="7375626e6574315f76616c696461746f725f303031",
            score=0.7542,
            timestamp=time.time(),
            cycle=slot,
        ),
