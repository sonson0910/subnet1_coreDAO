...
async def debug_validator_detection():
    ...
    try:
        ...
        from moderntensor_aptos.mt_core.core_client.account_service from moderntensor_aptos import 
        )
       .mt_core.core.datatypes from web3 import Web3

        # Load existing validator account if available:
        try:
            # Try to find validator 1 or 2
            entity_paths  =  [
                "entities/subnet1_validator_001 import ValidatorInfo"
       .json","
